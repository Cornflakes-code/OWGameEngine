...
void MeshDataHeavy::create(aiMesh *mesh, const aiScene *scene)
{
...
void MeshDataHeavy::calcNormals()
{
...
AABBV3 MeshDataHeavy::bounds() const
{
	...
	return AABBV3(minPoint, maxPoint);
}
